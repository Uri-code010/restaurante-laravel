...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    ...
    <div class="flex bg-white shadow-lg rounded-lg overflow-hidden w-3/4 max-w-4xl">
        ...
        <!-- Formulario -->
        <div class="w-1/2 p-8">
            <h2 class="text-3xl font-bold text-yellow-600 text-center mb-6"> Registro de Usuario</h2>
            <p class="text-gray-600 text-center mb-6">Crea tu cuenta para comenzar</p>
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="mb-4">
                    ...
                    <select name="role" id="role"
                        class="w-full border rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-yellow-500" required>
